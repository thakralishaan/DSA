class Solution {
    public int maxProfit(int[] prices) {
        ...
        return maxProfit(prices,0,1,2 , new HashMap<String,Integer>()); // taking currentday=0 , canbuy as 1 so that on buying we decrease its value and then 1 for transcount as a metric to check if it is still left
